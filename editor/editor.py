...
mainDisplay = pygame.display.set_mode((display_width*windowScale,display_height*windowScale))
...
def redrawScreen(gameDisplay, sectionSelected, selectedImage, startAt, imagePositions, imageData, fileList, thumbnails, displayingOnLeft, gridScale, gridPlaceX, gridPlaceY, currentMap, gridStartAtX, gridStartAtY, imageCache):
    ...
    mainDisplay.blit(pygame.transform.scale(gameDisplay, (display_width*windowScale,display_height*windowScale)), (0,0))
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                unscaledPos = pygame.mouse.get_pos()
                pos = (unscaledPos[0] / windowScale, unscaledPos[1] / windowScale)
